...
namespace TaskTester.Imaging
{
	...
	public class BitmapHolder
	{
		...
		public BitmapHolder Open(string filename)
		{
			this.Open(File.OpenRead(filename));
            return this;
		}

		public BitmapHolder Open(Stream stream)
		{
		...
		public BitmapHolder Save(string filename)
		{
			this.Save(File.OpenWrite(filename));
            return this;
		}
		public BitmapHolder Save(Stream stream)
		{
